...
10. Threshold: minimum number of occurrences of a term. **50** reproduces the class map (637 terms); 20 to 30 gives a denser map.
...
## How to read the map (September 2026 build, 637 terms)
